...
% (2) Find ZLB threshold in Trim 3 that ensures at least 30k period sequence of
% shocks
...
X_Taylor_series_final = [X_Taylor_series_trim_reverse,-X_Taylor_series_trim_reverse];
ELB_Taylor_hits_final = [ELB_Taylor_hits_trim_reverse,-ELB_Taylor_hits_trim_reverse];
ELB_Taylor_expected_final = [ELB_Taylor_expected_trim_reverse,-ELB_Taylor_expected_trim_reverse];
shock_series_final = [shock_series_trim_reverse,-shock_series_trim_reverse];
shock_series_raw_final = [shock_series_raw_trim_reverse,-shock_series_raw_trim_reverse];