...
X_Taylor_series_trim     = zeros(grid.num_endo,num_combine_sets*refresh_size);
ELB_Taylor_hits_trim     = zeros(1,num_combine_sets*refresh_size);
ELB_Taylor_expected_trim = zeros(1,num_combine_sets*refresh_size);
shock_series_trim        = zeros(grid.numstates_shocks,num_combine_sets*refresh_size);
shock_series_raw_trim    = zeros(grid.numstates_shocks,num_combine_sets*refresh_size);

X_Taylor_series_trim_reverse     = zeros(grid.num_endo,num_combine_sets*refresh_size);
ELB_Taylor_hits_trim_reverse     = zeros(1,num_combine_sets*refresh_size);
ELB_Taylor_expected_trim_reverse = zeros(1,num_combine_sets*refresh_size);
shock_series_trim_reverse        = zeros(grid.numstates_shocks,num_combine_sets*refresh_size);
shock_series_raw_trim_reverse    = zeros(grid.numstates_shocks,num_combine_sets*refresh_size);
