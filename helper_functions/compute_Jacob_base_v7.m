function out = compute_Jacob_base_v7(param,grid,SS_stats,idx,StateSS,ControlSS)
...
switch(param.adjust)
	case('G')
		...
		% F44_aux(LT_ind,end-grid.oc+LT_ind)  = SS_stats.LT;
		% F44_aux(LT_ind,end-grid.oc+C_b_ind) = SS_stats.C_b;
