function out = compute_Jacob_base_Taylor_v4(param,grid,SS_stats,idx,StateSS,ControlSS)
...
F24_aux(pastG_ind,end-grid.oc+w2_ind)     = -(log(w2_aux)-log(w2_ss))/perturb_size;
...
F43_aux(w2_ind,end-grid.os+pastG_ind)     = - param.rho_w * (log(pastG_aux/param.w_bar) - log(pastG_ss/param.w_bar))/perturb_size;
