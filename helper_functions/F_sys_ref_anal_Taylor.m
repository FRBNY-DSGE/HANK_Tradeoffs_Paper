function [Difference,LHS,RHS,MUnext,c_a_star,b_a_star,a_a_star,c_n_star,b_n_star,AC,AProb,P_transition_exp,P_transition_dist] = F_sys_ref_anal_Taylor(State,Stateminus,...
