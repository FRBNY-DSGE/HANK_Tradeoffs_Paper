...
% for kk = 1:2
    ...
    for jj =1:compute_start_period-1
        ...
        W2         = w2_IRFs(1,tt);
        nn2        = ((1-param.tau_w)*W2/param.psi)^(1/param.xi);
        PROFIT2    = Profit2_IRFs(1,tt);
        Profit_FI2 = Profit_FI2_IRFs_p(1,tt);

        % if tt == 1
        %     R_cbminus = param.R_cb;
        % else
        %     R_cbminus = Rcb_IRFs(1,tt-1);
            % end
        ...
        u_CE   = unemp_IRFs_p(1,tt);

        if tt > 1

            uminus_CE = unemp_IRFs_p(1,tt-1);
        ...
        f_init = log(SS_stats.f);
        options = optimset('disp','none','TolFun',1e-15,'TolX',1e-15);

        [out_f,~,exitflag_alpha] = fsolve(@(x) find_f(x,uminus_CE,u_CE,param,grid),f_init,options);
        ...
        unext_CE = unemp_IRFs_p(1,tt+1);

        f_init = log(SS_stats.f);
        options = optimset('disp','none','TolFun',1e-15,'TolX',1e-15);

        [out_f,~,exitflag_alpha] = fsolve(@(x) find_f(x,u_CE,unext_CE,param,grid),f_init,options);
        ...
        input(2).C_b                = SS_stats.C_b;
        input(2).Ntilde             = Ntilde;
        input(2).R_A                = R_A;
        input(2).Q                  = Q;
        input(2).Qminus             = Qminus;
        ...
        % input(9).nn                 = SS_stats.nn;
        input(9).nn                 = nn2;
        input(9).N                  = SS_stats.N;
        input(9).W                  = W2;
        input(9).tau_w              = param.tau_w;
        input(9).tau_a              = param.tau_a;
        input(9).PROFIT             = PROFIT2;
        input(9).C_b                = SS_stats.C_b;
        input(9).Ntilde             = SS_stats.Ntilde;
        input(9).R_A                = R_A2;
        input(9).Q                  = 1;
        input(9).Qminus             = 1;
        input(9).R_cbminus          = SS_stats.R_cbminus;
        input(9).R_cb               = SS_stats.R_cb;
        input(9).PI                 = SS_stats.PI;
        input(9).PInext             = SS_stats.PInext;
        input(9).P_transition_exp2  = P_transition_exp_ss;
        input(9).MU_tilde           = MU_tilde_ss;
        input(9).UU                 = 1;
        input(9).LT                 = SS_stats.LT;
        input(9).vartheta           = 1;
        input(9).P_transition_exp   = P_transition_exp_ss;
        input(9).AA_aux             = 1;
        % input(9).Profit_FI          = SS_stats.Profit_FI;
        input(9).Profit_FI          = Profit_FI2;

        % 10) PI - R

        input(10).nn                 = SS_stats.nn;
        input(10).N                  = SS_stats.N;
        input(10).W                  = param.w_bar;
        input(10).tau_w              = param.tau_w;
        input(10).tau_a              = param.tau_a;
        input(10).PROFIT             = SS_stats.Profit;
        input(10).C_b                = SS_stats.C_b;
        input(10).Ntilde             = SS_stats.Ntilde;
        input(10).R_A                = SS_stats.r_a;
        input(10).Q                  = 1;
        input(10).Qminus             = 1;
        input(10).R_cbminus          = SS_stats.R_cbminus;
        input(10).R_cb               = SS_stats.R_cb;
        input(10).PI                 = PI;
        input(10).PInext             = PInext;
        input(10).P_transition_exp2  = P_transition_exp_ss;
        input(10).MU_tilde           = MU_tilde_ss;
        input(10).UU                 = 1;
        input(10).LT                 = SS_stats.LT;
        input(10).vartheta           = 1;
        input(10).P_transition_exp   = P_transition_exp_ss;
        input(10).AA_aux             = 1;
        input(10).Profit_FI          = Profit_FI2;

        % 11) PI

        input(11).nn                 = SS_stats.nn;
        input(11).N                  = SS_stats.N;
        input(11).W                  = W2;
        input(11).tau_w              = param.tau_w;
        input(11).tau_a              = param.tau_a;
        input(11).PROFIT             = PROFIT2;
        input(11).C_b                = SS_stats.C_b;
        input(11).Ntilde             = SS_stats.Ntilde;
        input(11).R_A                = R_A2;
        input(11).Q                  = 1;
        input(11).Qminus             = 1;
        input(11).R_cbminus          = SS_stats.R_cbminus;
        input(11).R_cb               = SS_stats.R_cb;
        input(11).PI                 = PI;
        input(11).PInext             = PInext;
        input(11).P_transition_exp2  = P_transition_exp_ss;
        input(11).MU_tilde           = MU_tilde_ss;
        input(11).UU                 = 1;
        input(11).LT                 = SS_stats.LT;
        input(11).vartheta           = 1;
        input(11).P_transition_exp   = P_transition_exp_ss;
        input(11).AA_aux             = 1;
        input(11).Profit_FI          = Profit_FI2;



        parfor kkkk = 1:num_decomp_case+3
        ...
        if tt == 1
            ...
            Vshocks.VALUE_PI_W   = H_tilde_ss'*out(9).VALUE_aux2(:);
            ACshocks.AC_PI_W     = H_tilde_ss'*out(9).AC(:);
            Vshocks.VALUE_PI_W   = reshape(Vshocks.VALUE_PI_W,[grid.nb grid.na grid.nse]);
            ACshocks.AC_PI_W     = reshape(ACshocks.AC_PI_W,[grid.nb grid.na grid.nse]);

            Vshocks.VALUE_PI_R   = H_tilde_ss'*out(10).VALUE_aux2(:);
            ACshocks.AC_PI_R     = H_tilde_ss'*out(10).AC(:);
            Vshocks.VALUE_PI_R   = reshape(Vshocks.VALUE_PI_R,[grid.nb grid.na grid.nse]);
            ACshocks.AC_PI_R     = reshape(ACshocks.AC_PI_R,[grid.nb grid.na grid.nse]);

            Vshocks.VALUE_PI   = H_tilde_ss'*out(11).VALUE_aux2(:);
            ACshocks.AC_PI     = H_tilde_ss'*out(11).AC(:);
            Vshocks.VALUE_PI   = reshape(Vshocks.VALUE_PI,[grid.nb grid.na grid.nse]);
            ACshocks.AC_PI     = reshape(ACshocks.AC_PI,[grid.nb grid.na grid.nse]);
            ...
            CEs_PI_W    = ((Vshocks.VALUE_PI_W   - ACshocks.AC_PI_W   + AC_base)./VALUE_base).^(1/(1-param.sigma))-1;
            CEs_PI_R    = ((Vshocks.VALUE_PI_R   - ACshocks.AC_PI_R   + AC_base)./VALUE_base).^(1/(1-param.sigma))-1;
            CEs_PI      = ((Vshocks.VALUE_PI     - ACshocks.AC_PI     + AC_base)./VALUE_base).^(1/(1-param.sigma))-1;
        end
...
disp('-------------------------');
disp('')
fprintf(' CE for B01  : %1.2f \n', 10000*CE_I_PROFIT_B01);
fprintf(' CE for B1   : %1.2f \n', 10000*CE_I_PROFIT_B1);
fprintf(' CE for B10  : %1.2f \n', 10000*CE_I_PROFIT_B10);
fprintf(' CE for Q1   : %1.2f \n', 10000*CE_I_PROFIT_Q1);
fprintf(' CE for Q2   : %1.2f \n', 10000*CE_I_PROFIT_Q2);
fprintf(' CE for Q3   : %1.2f \n', 10000*CE_I_PROFIT_Q3);
fprintf(' CE for Q4   : %1.2f \n', 10000*CE_I_PROFIT_Q4);
fprintf(' CE for Q5   : %1.2f \n', 10000*CE_I_PROFIT_Q5);
fprintf(' CE for P90  : %1.2f \n', 10000*CE_I_PROFIT_P90);
fprintf(' CE for P99  : %1.2f \n', 10000*CE_I_PROFIT_P99);
fprintf(' CE for P999 : %1.2f \n', 10000*CE_I_PROFIT_P999);
